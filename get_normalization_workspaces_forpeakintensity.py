...
rawVan=ConvertUnits(InputWorkspace=rawVan,Target='Wavelength')
MaskBTP(Workspace=rawVan,Bank="13")
MaskBTP(Workspace=rawVan,Pixel="0-9,246-255")
MaskBTP(Workspace=rawVan,Tube="0-9,246-255")
rawVan=CropWorkspace(InputWorkspace=rawVan,XMin=lam_min,XMax=lam_max)

#Solid angle
sa=Rebin(InputWorkspace=rawVan,Params='{},{},{}'.format(lam_min, (lam_max-lam_min), lam_max),PreserveEvents='0')
SaveNexus(InputWorkspace=sa, Filename="/home/ntv/Desktop/data_folding/MANDI_solidAngle.nxs")


#flux
rawVan = Rebin(InputWorkspace=rawVan, Params='{},{},{}'.format(lam_min, (lam_max-lam_min)/100., lam_max))
...
flux=Rebin(InputWorkspace=flux,Params='{},{},{}'.format(lam_min, (lam_max-lam_min)/100.0, lam_max))
for i in range(flux.getNumberHistograms()):
  try:
      ...
      pass
flux=Rebin(InputWorkspace=flux,Params='{},{},{}'.format(lam_min, (lam_max-lam_min), lam_max))
