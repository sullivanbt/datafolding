...
def getQuickTOFWS(box, peak, padeCoefficients, goodIDX=None, dtSpread=0.03, qMask=None,
    ...
    tofWS, ppl = getTOFWS(box, flightPath, scatteringHalfAngle, tof, peak, qMask, dtSpread=dtSpread,
                          ...
                          calc_pp_lambda=calc_pp_lambda, pplmin_frac=minppl_frac, pplmax_frac=maxppl_frac,
...
def getSample(run, DetCalFile,  workDir, fileName, qLow=-25, qHigh=25, q_frame='sample', MDOutName='MDdata'):
    """
    ...
    MDdata = ConvertToMD(InputWorkspace=data, QDimensions='Q3D', dEAnalysisMode='Elastic',
                         ...
                         LorentzCorrection=False, OutputWorkspace=MDOutName)
    mtd.remove('data')
    return MDdata
...
def getBoxFracHKL(peak, peaks_ws, MDdata, UBMatrix, peakNumber, dQ, dQPixel=0.005, fracHKL=0.5, fracHKLRefine=0.2, q_frame='sample', outWSName='MDbox'):
    """
